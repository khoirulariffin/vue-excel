...
const { handleTouchEnd: imgTouchEnd, cleanup } = useTouchGestures()

const handleImgTouchEnd = (e: TouchEvent) => {
  imgTouchEnd(e, undefined, () => emit('openPreview'))
}
...
<template>
  <div class="w-full h-full relative group">
    ...
    <div
      ...
      @touchend.prevent="handleImgTouchEnd"
    >
    ...
    <div
      ...
      @touchstart.stop.prevent="emit('touchResizeStart', $event)"
    ></div>
    ...
    <div
      ...
      @touchstart.stop.prevent="emit('touchWidthResizeStart', $event)"
    ></div>
    ...
    <div
      ...
      @touchstart.stop.prevent="emit('touchHeightResizeStart', $event)"
    ></div>
  </div>
</template>
